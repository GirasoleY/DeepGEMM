...
class TestDenseAccuracyPolicy(unittest.TestCase):
    ...
    def test_combine_preflight_and_labels_precede_allocation_without_runtime_claim(self):
        ...
        self.assertIn("peer_parallel_ready_expert_spans_then_late_header", source)
        self.assertIn("warp_parallel_readiness_peer_independent_expert_immediate_issue", source)
        self.assertIn("no batching", source)
