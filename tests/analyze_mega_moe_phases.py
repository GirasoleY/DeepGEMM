...
def summarize_capture(capture: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "notes": [
            ...
            "With combine_overlap=1 first issue is retained in slots64–71. Without StrongVA, slots72–79 include late headers and slots80–87 report header flush. With StrongVA, slots72–79 record the final span terminal or zero-count header queue and slots80–87 report late-cleanup sender-local completion. Do not infer last-payload timing from these software observations.",
